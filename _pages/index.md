...
<div style="margin: 20px 0;">
  ...
  <div class="row" style="margin-top: 20px;">
    ...
    <div class="col-md-5" id="calendar" style="position: relative; left: 40px;">
      <iframe src="https://calendar.google.com/calendar/embed?showTitle=0&showNav=1&showPrint=0&showCalendars=0&mode=AGENDA&height=350&wkst=1&bgcolor=%23FFFFFF&src=61d8f01d5d00cb5bd304badc76c060acfa87badf0c68b180d1a0b78150cc9b2c%40group.calendar.google.com&color=%23125A12&ctz=America%2FLos_Angeles" style="border-width:0; min-height:300px;" width="100%" height="350" frameborder="0" scrolling="no"></iframe>
    </div>
  </div>
</div>
