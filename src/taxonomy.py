...
CATEGORY_KEYWORDS: dict[Category, list[str]] = {
    Category.PRECISION_AG: [
        ...
        "lidar", "spectroscopy", "phenotyping", "crop scouting",
    ],
    Category.FARM_SOFTWARE: [
        ...
        "decision support", "ag advisory", "agronomic software",
        "traceability platform", "climate smart", "agribusiness platform",
        "crop advisory", "digital agriculture",
    ],
    Category.BIOTECH: [
        ...
        "fermentation", "alternative protein", "bioplastic", "biopolymer",
        "plant extract", "novel crop input", "sustainable ingredient",
        "biomass", "metabolite", "synthetic protein", "novel ingredient",
        "plant-based", "cell culture", "tissue culture",
    ],
    Category.ROBOTICS: [
        ...
        "computer vision", "autonomous vehicle",
    ],
    Category.SUPPLY_CHAIN: [
        ...
        "food packaging", "cold storage", "novel packaging",
        "supply chain optimization", "food waste reduction",
    ],
    Category.WATER_IRRIGATION: [
        ...
        "evapotranspiration",
        "desalination", "water treatment", "water reuse",
        "membrane filtration", "groundwater", "water purification",
        "water recycling",
    ],
    Category.INDOOR_CEA: [
        "indoor farming", "vertical farming", "controlled environment",
        "greenhouse technology", "hydroponics", "aeroponics",
        "indoor agriculture", "grow room",
        "vertical farm", "plant factory", "aquaponic", "soilless",
    ],
    Category.AG_FINTECH: [
    ...
    Category.LIVESTOCK: [
        ...
        "animal welfare", "precision livestock", "fish farming",
        "animal technology", "veterinary", "poultry health",
    ],
    Category.FOOD_SAFETY: [
        ...
        "food tech", "food science", "food processing technology",
    ],
    Category.AG_BIOCONTROL: [
        ...
        "pheromone",
        "beneficial insect", "pest monitoring", "nematode",
    ...
    Category.CONNECTIVITY: [
        ...
        "iot platform", "connected device", "telematics",
        "rural wireless", "satellite connectivity",
    ],
}
